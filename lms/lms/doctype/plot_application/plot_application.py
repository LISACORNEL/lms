...
class PlotApplication(Document):
	...
	@frappe.whitelist()
	def record_fee_payment(self, payment_date, reference_no=None):
		"""Record the application fee via a Sales Invoice.

		Only the Sales Invoice is created (submitted immediately).
		The SI is paid/settled externally — no Payment Entry is created here.
